...
InternalData lastNameData = findTestData(GlobalVariable.dataL)

// Obtener correo
List<String> lastNameInvalid = lastNameData.getAllData().stream().map({ def data ->
	data[0]
}).collect(Collectors.toList())


// Iterar sobre cada dato
for (def lastName : lastNameInvalid) {
